...
const LinkManager = () => {
    ...
    return (
        <div className="min-h-screen font-nunito p-4 md:p-8 text-white relative bg-[#02124d]">
            {showIconPicker && (
                <IconPicker
            ...
            <div className="max-w-4xl mx-auto z-10 relative">
                <div className="flex justify-between items-center mb-8">
                    <div className="flex items-center gap-4">
                        <button onClick={() => navigate('/admin/frames')} className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition">
